...
//      if (!settings.isusingAll(SolvingTechnique.PointingClaiming,
    ...
    private void initGUI() {
        // This
        setTitle("Generate a random Latin Square");
        setResizable(false);
        ...
        btnPrev.setToolTipText("Restore the previous Latin Square");
        ...
        btnGenerate.setToolTipText("Generate a new random Latin Square that matches the given parameters");
                ...
                if (generator == null) {
                    if (!isTechniqueSetSafe()) {
                        int result = JOptionPane.showConfirmDialog(
                                ...
                                "The Latin Square Explainer may not be able to generate<br>" +
                                "a Latin Square with the selected parameters (it may loop<br>" +
        ...
        btnNext.setToolTipText("Restore the next Latin Square");
        ...
        selDifficulty.setToolTipText("Choose the difficulty of the Latin Square to generate");
        ...
        chkExactDifficulty.setToolTipText("Generate a Latin Square with exactly the chosen difficulty");
        ...
        chkMaximumDifficulty.setToolTipText("Generate a Latin Square with at most the chosen difficulty");
        ...
        "take from<br>a few seconds to some minutes to generate a new Latin Square.</body></html>");
        ...
        chkAnalysis = new JCheckBox("Show the analysis of the generated Latin Square");
        chkAnalysis.setToolTipText("Display the difficulty rating of the Latin Square and the " +
