...
public class TechniquesSelectDialog extends JDialog {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    if (!selectedTechniques.contains(SolvingTechnique.HiddenSingle)
                        ...
                        .showConfirmDialog(
                                ...
                                + "Without them, the Latin Square Explainer will fail to solve most Latin Squares.\n"
    ...
    private JPanel getTextPanel() {
        if (textPanel == null) {
            ...
            lblExplanations
            .setToolTipText("Solving techniques that are not selected will not be used when solving or analyzing a Latin Square");
