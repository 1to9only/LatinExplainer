...
public class SudokuIO {
    ...
    private static final String ERROR_MSG = "Unreadable Latin Square format";
    private static final String WARNING_MSG = "Warning: the Latin Square format was not recognized.\nThe Latin Square may not have been read correctly";
